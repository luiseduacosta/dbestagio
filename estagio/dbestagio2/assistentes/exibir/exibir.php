...
if($res_instituicao === false) die ("Nгo foi possнvel consultar as tabelas");
...
if($resultado === false) die ("Nгo foi possнvel consultar a tabela supervisores");
...
// Esta consulta eh para construir a caixa de seleзгo de instituicoes
$sql_estagio = "select * from estagio order by instituicao";
$res_estagio = $db->Execute($sql_estagio);
if($res_estagio == false) die ("Nгo foi possнvel consultar a tabela estagio");
