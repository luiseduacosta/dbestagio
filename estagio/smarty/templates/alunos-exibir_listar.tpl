...
<input type='submit' id='h_botao' value='Ver hist�rico' onClick='historia()'>
...
<table id="alunos" border="1" summary="Lista de alunos">
    ...
    <tr>
        ...
        <th style="text-align:center"><a href="?ordem=nivel{$criterio}">N�vel</a></th>
		<th style="text-align:center"><a href="?ordem=codigo{$criterio}">Cod</a></th>
		<th><a href="?ordem=periodo{$criterio}">Per�odo</a></th>
        <th><a href="?ordem=turno{$criterio}">Turno</a></th>
        <th><a href="?ordem=instituicao{$criterio}">Institui��o</a></th>
        <th><a href="?ordem=supervisor{$criterio}">Supervisor</a></th>
        <th><a href="?ordem=area{$criterio}">�rea</a></th>
...
<table id="alunos" border="1" summary="Lista de alunos">
	...
	<tr>
		...
		<th colspan='4' style="text-align:center">N�veis</th>
		...
		<th><a href="?ordem=titulo&seleciona_instituicao={$seleciona_instituicao}&seleciona_periodo={$seleciona_periodo}&seleciona_turno={$seleciona_turno}&seleciona_nivel={$seleciona_nivel}&seleciona_professor={$seleciona_professor}&id_area={$id_area}">T�tulo</a></th>
		<th><a href="?ordem=mono_area&seleciona_instituicao={$seleciona_instituicao}&seleciona_periodo={$seleciona_periodo}&seleciona_turno={$seleciona_turno}&seleciona_nivel={$seleciona_nivel}&seleciona_professor={$seleciona_professor}&id_area={$id_area}">�rea</a></th>
		<th><a href="?ordem=mono_periodo&seleciona_instituicao={$seleciona_instituicao}&seleciona_periodo={$seleciona_periodo}&seleciona_turno={$seleciona_turno}&seleciona_nivel={$seleciona_nivel}&seleciona_professor={$seleciona_professor}&id_area={$id_area}">Per�odo</a></th>
