...
/*
    ...
    if($res_supervisores === false) die ("Não foi possível consultar a tabela supervisores/instit_super");
    ...
    // Aumento em uma unidade a quantidade de paginas quando a quantidade de supervisores é maior de 4 
