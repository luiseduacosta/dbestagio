		...
		<table border="1" width="95%">
			<tbody>
				...
				<tr style="background-color:#e7e1ae;">
					...
					<td style="background-color:red;">Email ainda não enviado</td>
					{else}
					...
					<td colspan="2" class="coluna_centralizada">
						...
						*}
						...
						{if $data_hoje <= $data_inscricao} <span class="botao">
							...
							<span class="botao">
								{if $muralestagio_id == ""}
								<a href="listaInscritos.php?muralestagio_id={$instituicao[item].muralestagio_id}">Alunos
									inscritos</a>
								{else}
								<a href="listaInscritos.php?muralestagio_id={$instituicao[item].muralestagio_id}">Alunos
									inscritos</a>
							...
							<span class="botao">
								{if $muralestagio_id == ""}
								<a href="excluir.php?muralestagio_id={$instituicao[item].muralestagio_id}">Excluir</a>
								{else}
								<a href="excluir.php?muralestagio_id={$muralestagio_id}">Excluir</a>
								{/if}
							</span>
							{/if}
